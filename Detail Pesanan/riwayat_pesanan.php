...
<body>
    ...
    <div class="main-menu">
        <ul>
            <li><a href="#home">Riwayat Pesanan</a></li>
            <li><a href="../Detail Pesanan/status_pesanan.php">Status Pesanan</a></li>
    ...
    <div class="order-container">
        ...
        <div class="order-item">
            ...
            <div class="order-status status-dibatalkan">Dibatalkan</div>
        </div>
        <div class="order-item">
            <img src="../gambar/1735718697_produk2.jpg" alt="gambar">
            <div class="order-details">
            ...
            <div class="order-status status-selesai">Selesaai</div>
        </div>
        <div class="order-item">
            <img src="../gambar/1735718697_produk2.jpg" alt="gambar">
            <div class="order-details">
            ...
            <div class="order-status status-selesai">Selesai</div>
        </div>
        <div class="order-item">
            <img src="../gambar/1735718697_produk2.jpg" alt="gambar">
            <div class="order-details">
