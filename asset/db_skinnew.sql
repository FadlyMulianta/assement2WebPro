...
(70, 3, 'hana@test.com', 1),
(71, 2, 'hana@test.com', 4);
...
(4, 'Toko Lorem', 'Jl.Sukapura Bandung', '@loremtoko');
...
('hana', 'sri', 'hana@test.com', 1147, 'cc03e747a6afbbcbf8be7668acfebee5', ''),
('imam', 'k', 'imam@test.com', 789, '202cb962ac59075b964b07152d234b70', ''),
...
--
ALTER TABLE `keranjang`
  MODIFY `id_keranjang` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
