...
if (isset($_POST['btnSimpan'])) {
    ...
    $sqlStatement = "INSERT INTO produk (id_produk, nama_produk, harga, stok, deskripsi_produk, gambar_produk, nama_toko,id_kategori) VALUES ('$id_produk', '$nama_produk', '$harga', '$stok', '$deskripsi_produk', '$photoName', '$nama_toko',1)";
    ...
    <div class="main-content">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-1 row">
                ...
                <div class="col-auto">
                    <input type="text" class="form-control" name="nama_toko" placeholder="Deskripsi Produk" required>
                </div>
            </div>
            <div class="mb-1 row">
                <div class="col-2">
